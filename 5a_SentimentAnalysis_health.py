...
health_key = ["health", "worldwaterday","wellbeing","goal3", "sdg3","cleanwater", "goal6","cleandrinkingwater", "sdg6", "worldwaterday", "sanitation", "nohunger","goal2","nutrition", "sdg2","zerohunger"]
...
health_text = df[(df['health'] == True)]

text_s = health_text['text']
#print text_s
